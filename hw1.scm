...
;;because the expression values will be parsed before running the application
;;(p) points to itself in an infinite recursion
;;
...
;;(if #t 0 (p))
;;0 
;;With normal-order evaluation expressions will be passed as needed in the application
;;They never need (p), they will reture the result zero.
;;
